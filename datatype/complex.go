...
func GetComplexNumbers() {
	// The complex numbers are divided into two parts: complex64 and complex128.
	// float32 and float64 are also part of these complex numbers.
	// The in-built function creates a complex number
	// from its imaginary and real part and in-built imaginary
